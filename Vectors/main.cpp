...
int main() {
    ...
    // vector <char> vowels (5);    // inititalized to zero all indexes 
    ...
    cout << test_scores[2] << endl; 
     ...
     cout << "\nThere are " << test_scores.size() << " scores in the vector" << endl;   // with the size method we can easily determine the size of the vector.
     cout << "===========================================================";
