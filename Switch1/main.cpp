...
int main() {
    ...
    cout << "Enter the latter grade you expect on the exam: ";
    cin >> letter_grade;
    
    switch (letter_grade) {
        case 'a':
        case 'A':
            cout << "You need a 90 or above, study harder!" << endl;
            break;
        case 'b':
        case 'B':
        ...
        break;
            ...
            cout << "Hmm, you should strive for a better grade.You suck!" << endl;
